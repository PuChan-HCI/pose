    ...
    while True:
        ...
        if results.multi_face_landmarks is not None:
            ...
            image_points = (
                    ...
                    * np.array([cap_width, cap_height])[None, :]
            )
        ...
        cv.putText(debug_image, 'yaw : ' + str(yaw), (10, 60), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv.putText(debug_image, 'pitch : ' + str(pitch), (10, 90), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv.putText(debug_image, 'roll : ' + str(roll), (10, 120), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
